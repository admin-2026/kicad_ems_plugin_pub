"""Is there a newer Antenna Designer than the one running?
...
The dependency arrows all point one way (strip -> checker -> github -> model /
version), and the source is injected: ``check`` takes any zero-argument
