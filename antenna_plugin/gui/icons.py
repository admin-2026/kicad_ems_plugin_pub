...
shell and the sections just ask for a file name at the size they show it. The
art is square and oversized on purpose (see tools/icons/scan.py), and scaling
...
# The installed package: the tab icons sit directly in it, the illustrations
